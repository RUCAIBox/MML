...
from recbole.quick_start import run_emb_gen_train
...
if __name__ == '__main__':
    try:
        ...
        result = run_emb_gen_train(model=args.model, dataset=args.dataset, config_file_list=config_file_list, saved=saved)
        try:
