...
from recbole.quick_start import run_meta_train
...
if __name__ == '__main__':
    try:
        ...
        result = run_meta_train(model=args.model, dataset=args.dataset, config_file_list=config_file_list, saved=saved)
        try:
